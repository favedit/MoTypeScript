...
-- ------------------------------------------------------------
-- Create table [Data.Control.Cockpit.Module]
-- ------------------------------------------------------------	 	  
CREATE TABLE `DT_CTL_COCKPIT_MODULE` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
...
ALTER TABLE DT_CTL_COCKPIT_MODULE 
   ADD CONSTRAINT DT_CTL_COC_MO_UK_GID UNIQUE ( GUID ); 

-- ------------------------------------------------------------
-- Create table [Data.Control.Cockpit.User.Module]
-- ------------------------------------------------------------	  
DROP TABLE IF EXISTS `DT_CTL_COCKPIT_USER_MODULE`;
CREATE TABLE `DT_CTL_COCKPIT_USER_MODULE` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
...
ALTER TABLE DT_CTL_COCKPIT_USER_MODULE 
   ADD CONSTRAINT DT_CTL_COC_MO_UK_GID UNIQUE ( GUID ); 

ALTER TABLE DT_CTL_COCKPIT_USER_MODULE 
   ADD CONSTRAINT DT_CTL_COC_MO_UK_MOD UNIQUE ( USER_ID, MODULE_ID ); 

ALTER TABLE DT_CTL_COCKPIT_USER_MODULE ADD CONSTRAINT DT_CTL_COC_MO_FK_UER 
      FOREIGN KEY (`USER_ID`) REFERENCES DT_PSN_USER(`OUID`); 

ALTER TABLE DT_CTL_COCKPIT_USER_MODULE ADD CONSTRAINT DT_CTL_COC_MO_FK_MOD 
      FOREIGN KEY (`MODULE_ID`) REFERENCES DT_CTL_COCKPIT_MODULE(`OUID`);
...
-- ------------------------------------------------------------
-- Create table [Data.Person.User.Feedback]
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `DT_PSN_USER_FEEDBACK`;	  
CREATE TABLE `DT_PSN_USER_FEEDBACK` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
   `USER_ID`                       BIGINT, 
   `ANONYMOUS_CD`                  INTEGER, 
   `RECORD_DATE`                   DATETIME, 
   `CONTENT`                       TEXT, 
   `NOTE`                          VARCHAR(800), 
   `CREATE_USER_ID`                BIGINT, 
...
ALTER TABLE DT_PSN_USER_FEEDBACK 
   ADD CONSTRAINT DT_PSN_USR_FBC_UK_GID UNIQUE ( GUID ); 
...
-- ------------------------------------------------------------
-- Create table [Data.Financial.User]
-- 151204 maocy
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `DT_FIN_USER`;
CREATE TABLE `DT_FIN_USER` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
...
ALTER TABLE DT_FIN_USER 
   ADD CONSTRAINT DT_FIN_USR_UK_GID UNIQUE ( GUID ); 
...
-- ------------------------------------------------------------
-- Create table [Data.Financial.Customer.Feedback`]
-- 20151108 AnjoyTian 客户行为日志
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `DT_FIN_CUSTOMER_FEEDBACK`;  
CREATE TABLE `DT_FIN_CUSTOMER_FEEDBACK` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
...
ALTER TABLE DT_FIN_CUSTOMER_FEEDBACK 
   ADD CONSTRAINT DT_FIN_CST_FEE_UK_GID UNIQUE ( GUID ); 
...
-- ------------------------------------------------------------
-- Create table [Data.Financial.Ranklist]
-- 20151122 sunhr
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `DT_FIN_RANKLIST`;
CREATE TABLE `DT_FIN_RANKLIST` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
...
ALTER TABLE DT_FIN_RANKLIST 
   ADD CONSTRAINT DT_FIN_RKL_UK_GID UNIQUE ( GUID ); 
...
ALTER TABLE DT_ORG_DEPARTMENT_USER ADD CONSTRAINT DT_ORG_DEP_USR_FK_DEP 
      FOREIGN KEY (`DEPARTMENT_ID`) REFERENCES DT_ORG_DEPARTMENT(`OUID`); 

ALTER TABLE DT_ORG_DEPARTMENT_USER ADD CONSTRAINT DT_ORG_DEP_USR_FK_USR 
      FOREIGN KEY (`USER_ID`) REFERENCES DT_PSN_USER(`OUID`); 