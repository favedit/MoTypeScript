         ...
         IConnectionConsole
{
   ...
   // 读取名称集合
   @AProperty
   protected String _readNames;

   // 读取名称集合
   protected String[] _readNameItems;

   // 写出名称集合
   @AProperty
   protected String _writeNames;

   // 写出名称集合
   protected String[] _writeNameItems;
   ...
   public String[] readNames(){
      if(_readNameItems == null){
         if(!RString.isEmpty(_readNames)){
            _readNameItems = RStrings.splitTrimNotEmpty(_readNames, ',');
         }
      }
      return _readNameItems;
   }
   ...
   public String[] writeNames(){
      if(_writeNameItems == null){
         if(!RString.isEmpty(_writeNames)){
            _writeNameItems = RStrings.splitTrimNotEmpty(_writeNames, ',');
         }
      }
      return _writeNameItems;
   }
