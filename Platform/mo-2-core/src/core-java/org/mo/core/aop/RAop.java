...
public class RAop
{
   ...
   public static <V> V find(String face){
      try{
         ...
         throw new FFatalError(exception, "Find component failed. (class={1})", face);
      }
   }
   ...
   public static <V> V find(Class<V> clazz){
      try{
         ...
         throw new FFatalError(exception, "Find component failed. (class={1})", clazz.getName());
      }
   }
   ...
   public static <V> V find(String session,
      ...
      try{
         ...
         _logger.error(null, "find", exception, "find class {1}", face);
      }
      return result;
   }
   ...
   public static <V> V find(String session,
      ...
      try{
         ...
         _logger.error(null, "find", exception, "find class {1}", clazz);
      }
      return result;
   }
