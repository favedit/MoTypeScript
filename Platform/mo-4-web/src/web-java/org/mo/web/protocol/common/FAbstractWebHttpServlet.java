...
// <T>网络处理。</T>
//============================================================
public abstract class FAbstractWebHttpServlet
      extends HttpServlet
      implements
         IWebServlet
{
   ...
   // 日志输出接口
   private static final ILogger _logger = RLogger.find(FAbstractWebHttpServlet.class);
         ...
         if(RString.isEmpty(sessionCode)){
            ...
            if(cookies != null){
               for(Cookie cookie : cookies){
                  ...
                  if(EWebConstants.SessionId.equals(cookieName)){
   ...
   // @return 会话编号
   //============================================================
   public String buildSessionId(HttpServletRequest httpRequest,
                                HttpServletResponse httpResponse){
      // 新建会话编号
      String sessionCode = RUuid.makeUniqueIdLower();
      // 设置会话编号
      Cookie cookie = new Cookie(EWebConstants.SessionId, sessionCode);
      cookie.setPath("/");
      cookie.setMaxAge(-1);
   ...
   // @param httpResponse 页面响应对象
   //============================================================
   public void sessionStart(IWebSession session){
   }
