      ...
      try{
         ...
         if(methodDescriptor.sessionRequire()){
            if(_accessRule != null){
               ...
               if(resultCd != EResult.Success){
                  return redirect(context, _messageConsole.pageSession());
               }
            }
         }
         // 检查当前处理是否需要登录
         if(methodDescriptor.loginRequire()){
            if(_accessRule != null){
               ...
               if(resultCd != EResult.Success){
                  return redirect(context, _messageConsole.pageLogin());
               }
            }
         }
         // 检查当前处理是否需要登录
         ...
         if((role != null) || (authority != null)){
            if(_accessRule != null){
               ...
               if(resultCd != EResult.Success){
                  return redirect(context, _messageConsole.pageAuthority());
               }
            }
         }
         //............................................................
