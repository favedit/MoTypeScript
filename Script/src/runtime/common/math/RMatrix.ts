import {RArray} from '../lang/RArray'
...
export class RMatrix {
   ...
   //==========================================================
   public static perspectiveLH(matrix, width, height, znear, zfar) {
   ...
   //==========================================================
   public static perspectiveRH(matrix, width, height, znear, zfar) {
      var data = matrix.data();
      // 填充行1数据
      data[0] = 2 * znear / width;
      data[1] = 0;
   ...
   // @param zfar:zfar:Number 远平面
   //==========================================================
   public static perspectiveFieldOfViewLH(matrix, fieldOfView, aspectRatio, znear, zfar) {
      var data = matrix.data();
   ...
   // @param zfar:zfar:Number 远平面
   //==========================================================
   public static perspectiveFieldOfViewRH(matrix, fieldOfView, aspectRatio, znear, zfar) {
      var data = matrix.data();
      var sy = 1 / Math.tan(fieldOfView * 0.5);
      var sx = sy / aspectRatio;
      // 填充行1数据
   ...
   //==========================================================
   public static orthoLH(matrix, left, top, width, height, znear, zfar) {
      var o = this;
      // 计算变量
   ...
   // @param zfar:Float 远平面
   //==========================================================
   public static orthoRH(matrix, left, top, width, height, znear, zfar) {
      var o = this;
      // 计算变量
      var right = left + width;
      var bottom = top + height;
