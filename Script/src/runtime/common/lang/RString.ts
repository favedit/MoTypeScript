...
export class RString {
   ...
   static PAD: string = ' ';
   static TRIM: string = ' \t\r\n';
   static LOWER: string = 'abcdefghijklmnopqrstuvwxyz';
   static UPPER: string = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
   static CodeLowerA: number = 'a'.charCodeAt(0);
   static CodeLowerZ: number = 'z'.charCodeAt(0);
   static CodeUpperA: number = 'A'.charCodeAt(0);
   static CodeUpperZ: number = 'Z'.charCodeAt(0);
   // @attribute
   static _hashData = null;
