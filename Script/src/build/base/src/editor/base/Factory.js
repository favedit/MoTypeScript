...
define(["require", "exports", './app/Professional'], function (require, exports, Professional_1) {
    "use strict";
    var SkApp = (function (_super) {
        __extends(SkApp, _super);
        function SkApp() {
    ...
    function initSkApp() {
        ...
        var taskManager = {
            ...
            loadTask: function () {
                ...
                this.completed = this.completed.then(function () {
                    var result = itemNameList.map(function (item) {
            ...
            loadFile: function (fileUrl, fileType) {
                var promise;
                switch (fileType) {
                    case "css":
                        promise = {
        ...
        $(function () {
            ...
            if (app.appParams.debug && "true" === queryConfig.log) {
                ...
                var debugWindow = window.debugWindow = new goog.debug.FancyWindow("main");
            ...
            taskManager.init(app)
                ...
                document.getElementsByName("description")[0].content = ResourceManager.getString("app_description");
                //site.init();
