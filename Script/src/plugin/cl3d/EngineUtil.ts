...
import {DeferredMergeAutomaticEffect} from './technique/effect/DeferredMergeAutomaticEffect';
import {DeferredSketchAutomaticEffect} from './technique/effect/DeferredSketchAutomaticEffect';
...
export class EngineUtil {
   ...
   public static staticConstructor() {
      ...
      effectConsole.register('deferred.merge.automatic', DeferredMergeAutomaticEffect);
      effectConsole.register('deferred.sketch.automatic', DeferredSketchAutomaticEffect);
