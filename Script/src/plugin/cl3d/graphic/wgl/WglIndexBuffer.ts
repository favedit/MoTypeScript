...
// @history 141230
//==========================================================
export class WglIndexBuffer extends IndexBuffer {
   //..........................................................
   // @attribute
   public handle = null;
   ...
   public upload(data: any, count?: number, remain: boolean = false): void {
      ...
      if ((dataClass == Array) || (dataClass == ArrayBuffer)) {
         if (this.strideCd == IndexStrideEnum.Uint16) {
            memory = new Uint16Array(data);
         } else if (this.strideCd == IndexStrideEnum.Uint32) {
         ...
         if (this.strideCd != IndexStrideEnum.Uint32) {
            throw new Fatal(this, 'Index stride16 is invalid.');
         }
         memory = data;
      } else {
