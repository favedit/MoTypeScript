...
// @history 141230
//==========================================================
export abstract class GraphicContext extends FBaseGraphicContext {
   //..........................................................
   // @attribute
   ...
   protected capability: ContextCapability;
   protected _statistics: ContextStatistics;
   // @attribute
   protected _fillModeCd: FillModeEnum = FillModeEnum.Face;
   ...
   public constructor() {
      ...
      this._statistics = ClassUtil.create(ContextStatistics);
   ...
   //==========================================================
   public abstract createVertexBuffer(clazz?: Function): VertexBuffer;
   ...
   //==========================================================
   public abstract createIndexBuffer(clazz?: Function): IndexBuffer;
