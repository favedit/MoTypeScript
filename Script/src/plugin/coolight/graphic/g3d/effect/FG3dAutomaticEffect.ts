...
import {FG3dEffect} from '../FG3dEffect';
import {EG3dAttribute} from '../EG3dAttribute';
import {EG3dSampler} from '../EG3dSampler';
...
// @history 150114
//==========================================================
export class FG3dAutomaticEffect extends FG3dEffect {
   // @attribute
   ...
   public buildInfo(tagContext, info) {
      ...
      //............................................................
      // 支持顶点颜色
      var ac = info.attributeContains(EG3dAttribute.Color);
      ...
      // 支持顶点纹理
      var ad = info.attributeContains(EG3dAttribute.Coord);
      ...
      // 支持法线
      var an = info.attributeContains(EG3dAttribute.Normal);
      ...
      // 支持全法线
      var ab = info.attributeContains(EG3dAttribute.Binormal);
      var at = info.attributeContains(EG3dAttribute.Tangent);
      var af = (an && ab && at);
      ...
      //............................................................
      // 支持透明技术
      var sdf = info.samplerContains(EG3dSampler.Diffuse);
      ...
      //............................................................
      // 支持透明纹理
      if (info.samplerContains(EG3dSampler.Alpha)) {
         tagContext.setBoolean("support.alpha.sampler", true);
      }
      //............................................................
      // 支持散射技术
      var snr = info.samplerContains(EG3dSampler.Normal);
      ...
      //............................................................
      // 支持高光技术
      var spc = info.samplerContains(EG3dSampler.SpecularColor);
      var spl = info.samplerContains(EG3dSampler.SpecularLevel);
      ...
      //............................................................
      // 支持发光技术
      var slg = info.samplerContains(EG3dSampler.Light);
      ...
      // 支持反射技术
      var slr = info.samplerContains(EG3dSampler.Reflect);
      ...
      // 支持折射技术
      var slf = info.samplerContains(EG3dSampler.Refract);
      ...
      // 支持发光技术
      var sle = info.samplerContains(EG3dSampler.Emissive);
      ...
      //............................................................
      // 支持高度技术
      var shg = info.samplerContains(EG3dSampler.Height);
      ...
      //............................................................
      // 支持环境技术
      var sen = info.samplerContains(EG3dSampler.Environment);
   ...
   // @param renderable:FG3dRenderable 渲染对象
   //==========================================================
   public drawRenderable(region, renderable, index: number = 0) {
      var o = this;
      var context = o._graphicContext;
      var program = o._program;
      // 绘制准备
      ...
      if (indexCount > 1) {
         ...
         throw new FError(o, 'Index buffer is not found.');
      }
