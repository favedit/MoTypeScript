...
// @history 150119
//==========================================================
//export class FG3dSelectSkeletonEffect extends FG3dAutomaticEffect {
   export class FG3dSelectSkeletonEffect {
   // @attribute
   _code: string = 'select.automatic';
   ...
   // //==========================================================
   // public drawRenderable2(pg, pr, pi) {
   //    var o = this;
   ...
   //    //p.setParameter('vc_vp_matrix', pg.calculate(sk.graphic.context3d.EG3dRegionParameter.CameraViewProjectionMatrix));
