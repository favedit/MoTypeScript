...
import {FEffect} from '../../../graphic/g3d/FEffect';
import {FRegion} from '../../../graphic/base/FRegion';
import {FRenderable} from '../../../graphic/base/FRenderable';
import {FProgramAttribute} from '../../../graphic/g3d/FProgramAttribute';
import {FProgramSampler} from '../../../graphic/g3d/FProgramSampler';
...
// @history 150114
//==========================================================
export class FAutomaticEffect extends FEffect {
   // @attribute
   ...
   public buildInfo(tagContext, info) {
      ...
      //............................................................
      // 支持顶点颜色
      var ac = info.attributeContains(EAttribute.Color);
      ...
      // 支持顶点纹理
      var ad = info.attributeContains(EAttribute.Coord);
      ...
      // 支持法线
      var an = info.attributeContains(EAttribute.Normal);
      ...
      // 支持全法线
      var ab = info.attributeContains(EAttribute.Binormal);
      var at = info.attributeContains(EAttribute.Tangent);
      var af = (an && ab && at);
      ...
      //............................................................
      // 支持透明技术
      var sdf = info.samplerContains(ESampler.Diffuse);
      ...
      //............................................................
      // 支持透明纹理
      if (info.samplerContains(ESampler.Alpha)) {
         tagContext.setBoolean("support.alpha.sampler", true);
      }
      //............................................................
      // 支持散射技术
      var snr = info.samplerContains(ESampler.Normal);
      ...
      //............................................................
      // 支持高光技术
      var spc = info.samplerContains(ESampler.SpecularColor);
      var spl = info.samplerContains(ESampler.SpecularLevel);
      ...
      //............................................................
      // 支持发光技术
      var slg = info.samplerContains(ESampler.Light);
      ...
      // 支持反射技术
      var slr = info.samplerContains(ESampler.Reflect);
      ...
      // 支持折射技术
      var slf = info.samplerContains(ESampler.Refract);
      ...
      // 支持发光技术
      var sle = info.samplerContains(ESampler.Emissive);
      ...
      //............................................................
      // 支持高度技术
      var shg = info.samplerContains(ESampler.Height);
      ...
      //............................................................
      // 支持环境技术
      var sen = info.samplerContains(ESampler.Environment);
